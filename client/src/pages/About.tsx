      ...
      <section className="py-20 md:py-32 container mx-auto px-6">
        <div className="text-center mb-20">
          ...
          <p className="text-neutral-500 mt-6 max-w-xl mx-auto font-medium">
            Social media specialists building the bridge from content to
            conversion success.
          </p>
        </div>
            ...
            >
              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-4">
                  <a
                    href="#"
                    className="flex items-center gap-2 bg-neutral-900 border border-neutral-800 px-4 py-2 rounded-lg text-sm font-bold hover:bg-neutral-800 transition-colors"
                  >
